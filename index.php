...
<div class="login-box">
  	...
  	<div class="login-box-body">
    	<div class="login-box-msg" style="margin-top:-40px">Sign in to start your session as Voter</div>
  	...
  	?>
	<a class="btn btn-link w-100 mt-3" href="admin">Click here to Login as <b>ADMIN</b></a>
</div>
